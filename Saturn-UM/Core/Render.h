...
namespace Render
{
	...
	// Vertical Health Bar
	//////////////////////////////////////////////////////////////////////////
    inline void HealthBar::HealthBarV(float MaxHealth, float CurrentHealth, const ImVec2& Pos, const ImVec2& Size, bool ShowBar, bool ShowNum)
	{
		if (ShowBar || ShowNum)
		{
	...
	// Vertical Armor Bar
	//////////////////////////////////////////////////////////////////////////
    inline void HealthBar::ArmorBarV(bool HasHelmet, float MaxArmor, float CurrentArmor, const ImVec2& Pos, const ImVec2& Size, bool ShowBar, bool ShowNum)
	{
		if (ShowBar || ShowNum)
		{
	...
	// Horizontal Ammo Bar
	//////////////////////////////////////////////////////////////////////////
    inline void HealthBar::AmmoBarH(float MaxAmmo, float CurrentAmmo, const ImVec2& Pos, const ImVec2& Size)
	{
		ImDrawList* DrawList = ImGui::GetBackgroundDrawList();
    ...
    inline void DrawHealthBar(DWORD Sign, float MaxHealth, float CurrentHealth, const ImVec2& Pos, const ImVec2& Size)
	{
    ...
    inline void DrawArmorBar(DWORD Sign, float MaxArmor, float CurrentArmor, bool HasHelmet, const ImVec2& Pos, const ImVec2& Size)
	{
		static std::unordered_map<DWORD, HealthBar> HealthBarMap;
		if (HealthBarMap.size() > 64)
			HealthBarMap.clear();
