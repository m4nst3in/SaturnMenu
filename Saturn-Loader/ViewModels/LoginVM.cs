...
namespace Saturn.Loader.ViewModels
{
    public class LoginVM : INotifyPropertyChanged
    {
        ...
        public LoginVM(System.Action<User> onLogin)
        {
            ...
            OpenSiteCommand = new RelayCommand(() => System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo("https://example.com") { UseShellExecute = true }));
            _onLogin = onLogin;
        }
        private void Login()
        {
            var user = AuthService.Instance.Login(Username, Password);
