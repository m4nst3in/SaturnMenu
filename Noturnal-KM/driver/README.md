# Driver de Kernel Noturnal

Este diretório contém o código fonte do driver de kernel necessário para o Noturnal funcionar.
...
```bash
python convert_driver.py x64\Debug\Noturnal-kmd.sys output.txt
```

Ou simplesmente:

```bash
python convert_driver.py Noturnal-kmd.sys
```
