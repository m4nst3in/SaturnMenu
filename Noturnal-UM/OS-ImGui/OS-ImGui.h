...
namespace OSImGui
{
	...
	public:
		...
		// Carrega ícones removendo fundo (cor dominante das bordas) e deixando o ícone branco
		bool LoadTextureFromMemoryIcon(unsigned char* Memory, UINT size, ID3D11ShaderResourceView** out_srv, int* out_width, int* out_height);
