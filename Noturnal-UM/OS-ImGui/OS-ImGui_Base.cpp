    ...
    bool OSImGui_Base::InitImGui(ID3D11Device* device, ID3D11DeviceContext* device_context)
    {
        ...
        if (!faMerged)
        {
            ...
            const char* faPaths[] = {
                ...
                "Noturnal-UM/Resources/fa-solid-900.ttf",
                "../Noturnal-UM/Resources/fa-solid-900.ttf"
            };
        ...
        style.Colors[ImGuiCol_Button]          = ImVec4(0.486f, 0.227f, 0.929f, 0.50f);
        style.Colors[ImGuiCol_ButtonHovered]   = ImVec4(0.600f, 0.300f, 0.980f, 0.90f);
        style.Colors[ImGuiCol_ButtonActive]    = ImVec4(0.700f, 0.350f, 1.000f, 1.00f);
        style.Colors[ImGuiCol_CheckMark]       = ImVec4(0.486f, 0.227f, 0.929f, 1.00f);
        style.Colors[ImGuiCol_SliderGrab]      = ImVec4(0.486f, 0.227f, 0.929f, 1.00f);
        style.Colors[ImGuiCol_SliderGrabActive]= ImVec4(0.600f, 0.300f, 0.980f, 1.00f);
        style.Colors[ImGuiCol_Header]          = ImVec4(0.486f, 0.227f, 0.929f, 0.55f);
        style.Colors[ImGuiCol_HeaderHovered]   = ImVec4(0.600f, 0.300f, 0.980f, 0.90f);
        style.Colors[ImGuiCol_HeaderActive]    = ImVec4(0.700f, 0.350f, 1.000f, 1.00f);
        style.Colors[ImGuiCol_Separator]       = ImVec4(0.16f, 0.22f, 0.30f, 0.60f);
        style.Colors[ImGuiCol_SeparatorHovered]= ImVec4(0.600f, 0.300f, 0.980f, 0.78f);
        style.Colors[ImGuiCol_SeparatorActive] = ImVec4(0.600f, 0.300f, 0.980f, 1.00f);
        style.Colors[ImGuiCol_Tab]             = ImVec4(0.486f, 0.227f, 0.929f, 0.60f);
        style.Colors[ImGuiCol_TabHovered]      = ImVec4(0.600f, 0.300f, 0.980f, 0.90f);
        style.Colors[ImGuiCol_TabActive]       = ImVec4(0.560f, 0.270f, 0.950f, 1.00f);
