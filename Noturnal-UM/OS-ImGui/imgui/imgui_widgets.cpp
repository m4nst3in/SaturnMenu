...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    // Usar arredondamento do estilo para manter forma quadrada (sem círculo preenchido)
    ...
    if (mixed_value)
    {
        ...
        // Respeitar o arredondamento do estilo também no estado "mixed"
...
bool    ImGui::BeginTabBarEx(ImGuiTabBar* tab_bar, const ImRect& tab_bar_bb, ImGuiTabBarFlags flags)
{
    ...
    // Skip default underline separator below the TabBar
    return true;
}
