...
public:
    FileSink() : path("Noturnal.log"), maxSize(5 * 1024 * 1024) {}
    void consume(const LogMessage& m) override {
        ...
        if (h != INVALID_HANDLE_VALUE) {
            ...
            if (size.QuadPart >= (LONGLONG)maxSize) {
                ...
                MoveFileA(path.c_str(), ("Noturnal" + std::string(suffix)).c_str());
            }
        }
...
public:
    ...
    void render_window() {
        ...
        ImGui::Begin("Noturnal Logs", &open, ImGuiWindowFlags_NoCollapse);
...
public:
    PipeSink() {
        h = CreateFileA("\\\\.\\pipe\\NoturnalLoaderLog", GENERIC_WRITE, 0, NULL, OPEN_EXISTING, 0, NULL);
    }
    void consume(const LogMessage& m) override {
...
#define NOTURNAL_LOG_TRACE(cat, msg) ::NoturnalLogging::Logger::instance().log(::NoturnalLogging::Level::Trace, (cat), (msg))
#define NOTURNAL_LOG_DEBUG(cat, msg) ::NoturnalLogging::Logger::instance().log(::NoturnalLogging::Level::Debug, (cat), (msg))
#define NOTURNAL_LOG_INFO(cat, msg)  ::NoturnalLogging::Logger::instance().log(::NoturnalLogging::Level::Info,  (cat), (msg))
#define NOTURNAL_LOG_WARN(cat, msg)  ::NoturnalLogging::Logger::instance().log(::NoturnalLogging::Level::Warn,  (cat), (msg))
#define NOTURNAL_LOG_ERROR(cat, msg) ::NoturnalLogging::Logger::instance().log(::NoturnalLogging::Level::Error, (cat), (msg))
#define NOTURNAL_LOG_FATAL(cat, msg) ::NoturnalLogging::Logger::instance().log(::NoturnalLogging::Level::Fatal, (cat), (msg))
